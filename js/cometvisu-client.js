...
function CometVisu( urlPrefix )
{
  ...
  this.watchdogTimer = 3;                                // in Seconds - the alive check interval of the watchdog
  this.maxConnectionAge = 30;                            // in Seconds - restart if last read is older
  ...
  {
    console.log("handleSession: ", json);
    this.session = json.s; 
